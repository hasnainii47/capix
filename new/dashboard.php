...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Capix Employee Panel</title>
            ...
            <nav id="sidebar">
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="logo_section">
                        <a href="dashboard.php"><img class="logo_icon img-responsive" src="images/logo/logo.png" alt="#" /></a>
                     </div>
                  </div>
                  <div class="sidebar_user_info">
                     <div class="icon_setting"></div>
                     <div class="user_profle_side">
                        <div class="user_img"><img class="img-responsive" src="images/layout_img/male-avatar.png" alt="#" /></div>
                        <div class="user_info">
                           <h6><?= $_SESSION['name']; ?></h6>
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li class="active">
                        <a href="employees"><i class="fa fa-users orange_color"></i> <span>Employees</span></a>
                        ...
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="images/layout_img/male-avatar.png" alt="#" /><span class="name_user"><?= $_SESSION['name']; ?></span></a>
